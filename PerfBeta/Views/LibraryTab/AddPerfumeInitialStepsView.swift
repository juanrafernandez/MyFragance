        ...
        NavigationStack {
            ZStack { 
                ...
                VStack {
                    ...
                    case 1:
                        AddPerfumeStep1View(selectedPerfume: $selectedPerfume, perfumeViewModel: perfumeViewModel, onboardingStep: $onboardingStep, initialSelectedPerfume: perfumeToEdit, isAddingPerfume: $isAddingPerfume, showingEvaluationOnboarding: $showingEvaluationOnboarding)
                    case 2:
