#!/usr/bin/env python3
"""
Script para añadir las preguntas del flujo B4 a Firebase Firestore usando REST API
"""
...
with open(os.path.join(script_dir, 'flowB4_questions.json'), 'r', encoding='utf-8') as f:
...
print("\n✨ Proceso completado!")
print("🔄 Ahora ve a la app → Ajustes → Datos → Limpiar caché para cargar las nuevas preguntas")
