#!/usr/bin/env python3
"""
Script para añadir las preguntas expertas de perfil olfativo (serie C) a Firebase Firestore
"""
...
with open(os.path.join(script_dir, 'new_expert_questions.json'), 'r', encoding='utf-8') as f:
    questions = json.load(f)

print(f"📝 Total de preguntas expertas a añadir: {len(questions)}\n")
...
print("\n✨ Proceso completado!")
print("📊 Ahora tienes 16 preguntas de perfil olfativo en total:")
...
print("\n   Serie C (Expertas - orden 11-15):")
print("   - profile_C1_structure")
print("   - profile_C2_concentration")
print("   - profile_C3_reference_perfumes (autocomplete)")
print("   - profile_C4_seasonal_preference")
print("   - profile_C5_note_balance")
