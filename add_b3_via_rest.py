#!/usr/bin/env python3
"""
Script para añadir las preguntas del flujo B3 a Firebase Firestore usando REST API
"""
...
with open(os.path.join(script_dir, 'flowB3_questions.json'), 'r', encoding='utf-8') as f:
